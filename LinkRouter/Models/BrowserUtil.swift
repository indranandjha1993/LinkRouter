...
class BrowserUtil {
    ...
    static func loadBrowsers(
        ...
        if let linkrouter = NSWorkspace.shared.urlForApplication(withBundleIdentifier: Bundle.main.bundleIdentifier ?? "com.indranandjha.LinkRouter") {
            filteredUrlsForApplications.removeAll { $0 == linkrouter }
        }
